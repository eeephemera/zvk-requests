...
export default function LoginClient() {
  ...
  const shouldSkipRedirect = (): boolean => {
    ...
    try {
      ...
      console.error("Error in shouldSkipRedirect:", err);
      return false;
    }
  };
      ...
      <div className="min-h-screen flex items-center justify-center p-6">
        <div className="bg-discord-card rounded-lg shadow-lg w-full max-w-md p-6">
          ...
          <div className="space-y-4">
            ...
            <Link href="/" className="block w-full py-2 text-center bg-discord-border text-discord-text rounded-md hover:bg-opacity-80">
              Главная страница
            </Link>
          </div>
        </div>
