...
export default function AccessDenied() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6">
      <div className="bg-discord-card rounded-lg shadow-lg w-full max-w-lg p-8 animate-fadeIn">
        <div className="flex flex-col items-center text-center">
          <div className="w-20 h-20 bg-discord-danger/20 rounded-full flex items-center justify-center mb-6">
          ...
          <Link href={homePage} className="bg-discord-button-primary hover:bg-opacity-80 text-white font-bold px-6 py-3 rounded-md transition duration-150">
